...
import BirdFeederImg from "../assets/cat-cover/img17.png";
...
import CageImg from "../assets/cat-cover/img16.jpeg";
import BirdHouseHangingImg from "../assets/cat-cover/img8.png";
                ...
                <div className='flex flex-col md:grid md:grid-cols-3 gap-3'>
                    {categories.map((category) => {
                        ...
                        switch (category.name) {
                            ...
                            case "Bird House Hanging":
                                image = BirdHouseHangingImg;
                                break;
                        }
                        return (
                            <div
